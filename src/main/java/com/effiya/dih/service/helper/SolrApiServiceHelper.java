...
public class SolrApiServiceHelper {
    ...
    public void deleteDocumentsByIds(String coreName, List<String> ids) {
        ...
        try {
            ...
            logger.info("Successfully deleted {} documents from core: {}. Delete status: {}", 
                        ids.size(), coreName, deleteResponse.getStatus());
        } catch (Exception e) {
    ...
    public void commit(String coreName) {
        try {
            ...
            logger.info("Successfully committed changes to core: {}", coreName);
        } catch (Exception e) {
            logger.error("Failed to commit changes to core: {}", coreName, e);
